    ...
    <div className="min-h-screen bg-[#FFF9F6]">
      ...
      <main className="max-w-[640px] mx-auto px-6 py-16">
          ...
          <ul className="space-y-4">
            {TRUST_POINTS.map((point) => (
              <li key={point} className="flex items-start gap-3">
                ...
                <span className="text-[#2D1B1E] leading-snug">{point}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="rounded-2xl border border-[rgba(232,99,122,0.2)] bg-white p-8 mb-12 shadow-md text-center">
          ...
          <p className="text-3xl font-bold text-[#2D1B1E] mb-1">$14.99<span className="text-base font-normal text-[#8C6B5A]">/month</span></p>
        ...
        <div className="mb-12">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={item} className="flex items-start gap-3 text-sm text-[#2D1B1E]">
                <span className="text-[#E8637A] shrink-0 mt-0.5">·</span>
                {item}
              </li>
            ))}
          </ul>
