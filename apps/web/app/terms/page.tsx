    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12 space-y-10">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-[#140c18]">Terms of Service</h1>
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-3 pl-5 list-disc text-[#140c18]">
            <li>
        ...
        <section className="space-y-3">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 space-y-3">
            <p className="text-[#140c18] leading-relaxed font-medium">
        ...
        {/* Section 8 */}
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-[#140c18]">8. Contact</h2>
          <p className="text-[#140c18] leading-relaxed">
          ...
          <p className="text-[#140c18] leading-relaxed">
            ...
            <Link href="/privacy" className="text-[#c94f68] hover:underline">
              Privacy Policy
            </Link>{" "}
            or email{" "}
            <a
