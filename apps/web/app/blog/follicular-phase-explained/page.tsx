    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#140c18] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">What is the follicular phase?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">What happens hormonally</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">How long does the follicular phase last?</h2>
          <p>
          ...
          <p>
            Use our free <Link href="/cycle-calculator" className="text-[#c94f68] hover:underline font-medium">cycle length calculator</Link> to estimate the pattern in your cycles.
          </p>

          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Common symptoms and energy patterns</h2>
          <p>
          ...
          <p>
            ...
            <Link href="/symptoms/low-energy-menstrual-phase" className="text-[#c94f68] hover:underline font-medium">low energy during your period</Link>{" "}
            for the contrast at the start of the follicular phase.
          </p>

          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Exercise and nutrition in the follicular phase</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">How to track the follicular phase</h2>
          <p>
