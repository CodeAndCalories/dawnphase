    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#140c18] space-y-6 leading-relaxed">
          ...
          <p>
            Beyond privacy, Flo&apos;s prediction model is built around average cycle data. For women with cycles that fall neatly between 26 and 32 days, it works reasonably well. For women with <Link href="/conditions/pcos" className="text-[#c94f68] hover:underline font-medium">PCOS</Link>, <Link href="/conditions/perimenopause" className="text-[#c94f68] hover:underline font-medium">perimenopause</Link>, post-hormonal-contraception irregularity, or cycles outside that range, the predictions are often wrong — and wrong in ways that matter if you&apos;re trying to understand your fertility window or predict symptoms.
          </p>
          <p>
