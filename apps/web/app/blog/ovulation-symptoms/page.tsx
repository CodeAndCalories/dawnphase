    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#140c18] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">1. Cervical mucus changes</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">2. Basal body temperature (BBT) rise</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">3. Mid-cycle spotting</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">4. Increased libido</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">5. Breast tenderness</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">6. Mild bloating</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">7. Heightened senses</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">8. Positive ovulation predictor kit (OPK)</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">How to use these signs together</h2>
          <p>
