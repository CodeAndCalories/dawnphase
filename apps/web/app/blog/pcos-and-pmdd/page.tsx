    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#140c18] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Understanding each condition separately</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Can PCOS and PMDD coexist?</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Overlapping symptoms — and how to tell them apart</h2>
          ...
          <div className="overflow-x-auto rounded-xl border border-[rgba(130,80,170,0.12)] my-4">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#f4e6f0]">
                  <th className="text-left px-4 py-3 font-semibold text-[#5a3575]">Symptom</th>
                  <th className="text-center px-4 py-3 font-semibold text-[#5a3575]">PCOS</th>
                  <th className="text-center px-4 py-3 font-semibold text-[#5a3575]">PMDD</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {[
                  ...
                  <tr key={symptom} className="bg-white">
                    <td className="px-4 py-3 font-medium text-[#140c18]">{symptom}</td>
                    <td className="px-4 py-3 text-center text-[#3d2855] text-xs">{pcos}</td>
                    <td className="px-4 py-3 text-center text-[#3d2855] text-xs">{pmdd}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Why tracking is essential when you have both</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">The importance of cycle day data for diagnosis</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">How Dawn Phase tracks both</h2>
          ...
          <p>
            Learn more about{" "}
            <Link href="/conditions/pcos" className="text-[#c94f68] hover:underline font-medium">PCOS tracking in Dawn Phase</Link>
            {" "}or read our guide on{" "}
            <Link href="/blog/pmdd-vs-pms" className="text-[#c94f68] hover:underline font-medium">understanding the difference between PMDD and PMS</Link>
            . You can also explore the{" "}
            <Link href="/conditions/pmdd" className="text-[#c94f68] hover:underline font-medium">PMDD condition page</Link>
            {" "}for information on tracking PMDD symptoms specifically.
          </p>

          <div className="bg-[#f4e6f0] rounded-xl p-5 mt-6 border border-[rgba(130,80,170,0.12)]">
            <p className="text-sm font-semibold text-[#5a3575] mb-2">Important reminder</p>
