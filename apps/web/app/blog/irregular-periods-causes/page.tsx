    ...
    <div className="min-h-screen bg-[#ede8f7]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#140c18] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">1. PCOS (Polycystic Ovary Syndrome)</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">2. Perimenopause</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">3. Thyroid dysfunction</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">4. High stress and cortisol</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">5. Significant weight changes or low body fat</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">6. Stopping hormonal contraception</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">7. Excessive exercise</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">8. Structural causes (fibroids, polyps)</h2>
          ...
          <h2 className="text-2xl font-bold text-[#140c18] mt-8">Why tracking helps identify the cause</h2>
