    ...
    <div className="min-h-screen bg-[#FFF9F6]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-6 rounded-2xl p-8 text-center text-white" style={{ background: "linear-gradient(135deg, #E8637A, #F4956A)" }}>
          <h3 className="text-2xl font-bold mb-2">Discover your personal patterns</h3>
          <p className="mb-6 opacity-90">Log energy, mood, and sleep by cycle phase. 7-day free trial.</p>
