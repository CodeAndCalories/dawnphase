    ...
    <div className="min-h-screen bg-[#FFF9F6]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#2D1B1E] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Why symptom diaries matter for endometriosis</h2>
          ...
          <p>
            You can read more about the condition itself on the <Link href="/conditions/endometriosis" className="text-[#E8637A] hover:underline">Dawn Phase endometriosis page</Link>.
          </p>

          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">What to track every day</h2>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Pain score (0–10)</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Pain location</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Flow and bleeding</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Bowel and bladder symptoms</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Fatigue</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#2D1B1E] mt-6">Medications taken</h3>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">How to present your data to a specialist</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Patterns to look for across multiple cycles</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Using Dawn Phase for endo tracking</h2>
        ...
        <div className="mt-6 rounded-2xl p-8 text-center text-white" style={{ background: "linear-gradient(135deg, #E8637A, #F4956A)" }}>
          <h3 className="text-2xl font-bold mb-2">Build your endo symptom diary with Dawn Phase</h3>
          <p className="mb-6 opacity-90">Daily logs anchored to your cycle day. Export your data for appointments.</p>
