    ...
    <div className="min-h-screen bg-[#FFF9F6]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-[#2D1B1E] space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">What cycle syncing means</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">The hormonal basis</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#FDF6F0]">
                  <th className="text-left px-4 py-3 font-semibold text-[#C94B6D]">Phase</th>
                  <th className="text-left px-4 py-3 font-semibold text-[#C94B6D]">Dominant hormones</th>
                  <th className="text-left px-4 py-3 font-semibold text-[#C94B6D]">Energy / mood signature</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[rgba(232,99,122,0.08)]">
                <tr>
                  <td className="px-4 py-3 text-[#2D1B1E] font-medium">Menstrual</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Oestrogen and progesterone both low</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Low energy, inward focus, fatigue common</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[#2D1B1E] font-medium">Follicular</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Oestrogen rising</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Building energy, improving mood, motivation increases</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[#2D1B1E] font-medium">Ovulatory</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Oestrogen peak, LH surge, testosterone elevated</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Peak energy and confidence for many, heightened sociability</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-[#2D1B1E] font-medium">Luteal</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Progesterone rises, oestrogen falls then rises then both fall</td>
                  <td className="px-4 py-3 text-[#8C6B5A]">Variable; early luteal often calm, late luteal often PMS window</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Exercise syncing: what research supports</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Diet and nutrition syncing</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">Work and cognitive syncing</h2>
          ...
          <h2 className="text-2xl font-bold text-[#C94B6D] mt-8">The honest bottom line</h2>
        ...
        <div className="mt-6 rounded-2xl p-8 text-center text-white" style={{ background: "linear-gradient(135deg, #E8637A, #F4956A)" }}>
          <h3 className="text-2xl font-bold mb-2">Track your cycle phases with Dawn Phase</h3>
          <p className="mb-6 opacity-90">Know which phase you&apos;re in every day. Free for 7 days.</p>
