...
export const symptoms: Symptom[] = [
  ...
  // ── Ovulatory ────────────────────────────────────────────────────────────────
  {
    ...
    phase: "Ovulatory",
    metaTitle: "Ovulation Pain (Mittelschmerz): Causes, Duration & When to Worry",
    metaDescription: "Sharp or crampy pain on one side mid-cycle is usually ovulation. Here's what it feels like, how long it lasts, and signs it could be something else.",
    description:
  ...
  },
  {
    ...
    phase: "Ovulatory",
    metaTitle: "Ovulation Discharge: What's Normal, What's Not",
    metaDescription: "Clear, stretchy, egg-white discharge mid-cycle is normal — but texture, color and smell matter. Here's exactly what to look for and when to track it.",
    description:
  ...
  // ── Additional symptoms ───────────────────────────────────────────────────────
  {
    ...
    phase: "All",
    description: "Irregular periods are cycles that vary significantly in length, timing, or flow. They can signal hormonal imbalance, stress, thyroid issues, PCOS, or perimenopause.",
    causes: "Common causes include PCOS, perimenopause, thyroid dysfunction, significant stress, rapid weight change, over-exercising, or stopping hormonal birth control. In some cases no underlying cause is found.",
    tracking: "Log your period start and end dates every cycle, even when irregular. Over time you'll see your personal pattern. Note flow intensity, any spotting, and how you feel each day. 3-6 months of data helps your doctor significantly.",
    whenToSeeDoctor: "See a doctor if periods stop for 3+ months (and pregnancy is ruled out), if bleeding is extremely heavy, if you have severe pain, or if irregularity is new and unexplained.",
    related: ["irregular-periods-pcos", "irregular-periods-perimenopause", "heavy-period", "spotting-between-periods"],
    patternNote: "Tracking irregular cycles over several months reveals your personal pattern — even irregular cycles have their own rhythm.",
    metaTitle: "Irregular Periods: Causes, Tracking, and When to See a Doctor",
    metaDescription: "Irregular periods can have many causes — PCOS, perimenopause, stress, thyroid issues. Here's what to track and when to get checked.",
  },
  {
    slug: "spotting-between-periods",
    name: "Spotting Between Periods",
    phase: "All",
    description: "Spotting between periods is light bleeding that occurs outside of your normal period. It can happen for many reasons, most of which are benign, but persistent spotting should be investigated.",
    causes: "Common causes include ovulation spotting, hormonal fluctuations, starting or stopping birth control, implantation bleeding, cervical irritation, or in some cases underlying conditions like fibroids or polyps.",
    tracking: "Note when spotting occurs in your cycle (cycle day number), how heavy it is, colour, and any accompanying symptoms like pain or discharge. This information is very useful for your doctor.",
    whenToSeeDoctor: "See a doctor if spotting is persistent across multiple cycles, heavy, accompanied by pain, occurs after sex, or if you are postmenopausal.",
    related: ["irregular-periods", "heavy-period", "ovulation-discharge"],
    metaTitle: "Spotting Between Periods: What Causes It and When to Worry",
    metaDescription: "Light bleeding between periods is common and often harmless — but tracking when and how it happens tells you a lot. Here's what to know.",
  },
  {
    slug: "missed-period",
    name: "Missed Period",
    phase: "All",
    description: "A missed period is when your expected period does not arrive. While pregnancy is the most common cause, many other factors can delay or stop periods entirely.",
    causes: "Causes include pregnancy, significant stress, rapid weight loss, over-exercising, thyroid dysfunction, PCOS, perimenopause, hyperprolactinemia, or stopping hormonal birth control. Periods can also be delayed by illness.",
    tracking: "Track your cycle dates consistently so you know what your normal cycle length is. Log stress, sleep, diet changes, and exercise — all of these can affect timing. Note the last date of your previous period.",
    whenToSeeDoctor: "Take a pregnancy test first. See a doctor if periods are absent for 3+ months (amenorrhoea), if this is new and unexplained, or if you have other symptoms like hair loss, weight change, or discharge.",
    related: ["irregular-periods", "irregular-periods-pcos", "irregular-periods-perimenopause"],
    metaTitle: "Missed Period: Common Causes Beyond Pregnancy",
    metaDescription: "A missed period isn't always pregnancy. Stress, thyroid issues, PCOS, and perimenopause can all delay your cycle. Here's what to check.",
  },
  {
    slug: "painful-sex",
    name: "Painful Sex",
    phase: "All",
    description: "Pain during or after sex — known medically as dyspareunia — can be related to your cycle, hormonal changes, or underlying conditions. It is more common than often acknowledged and worth tracking.",
    causes: "Hormonal causes include low estrogen (common in perimenopause and postmenopause) causing vaginal dryness and thinning. Other causes include endometriosis, fibroids, ovarian cysts, pelvic floor dysfunction, or vulvodynia.",
    tracking: "Note when pain occurs in relation to your cycle, where exactly the pain is, whether it is on entry or deeper, and any accompanying symptoms. Cycle-phase patterns can help identify hormonal causes.",
    whenToSeeDoctor: "Always worth discussing with a healthcare provider. Particularly important if pain is new, worsening, or accompanied by bleeding, discharge, or pelvic pain at other times.",
    related: ["vaginal-dryness-perimenopause", "pelvic-pain", "irregular-periods-perimenopause"],
    metaTitle: "Painful Sex and Your Cycle: What the Connection Means",
    metaDescription: "Painful sex can be hormonal — low estrogen, endometriosis, and cycle phase all play a role. Here's what to track and when to see a doctor.",
  },
  {
    slug: "pelvic-pain",
    name: "Pelvic Pain",
    phase: "All",
    description: "Pelvic pain is pain felt in the lower abdomen or pelvis. It can be cycle-related, ovulation pain, period cramping, or a sign of an underlying condition. Tracking helps distinguish between types.",
    causes: "Cycle-related causes include period cramps, ovulation pain (mittelschmerz), and endometriosis. Non-cycle causes include fibroids, ovarian cysts, pelvic inflammatory disease, or musculoskeletal issues.",
    tracking: "Log pain location (left, right, central), intensity (1-10), type (cramping, stabbing, dull ache), duration, and where you are in your cycle. Patterns across cycles reveal whether pain is phase-linked.",
    whenToSeeDoctor: "See a doctor if pain is severe, persistent, accompanied by fever or unusual discharge, gets worse over time, or significantly affects daily life.",
    related: ["cramps-during-period", "ovulation-pain", "spotting-between-periods"],
    metaTitle: "Pelvic Pain and Your Cycle: Types, Causes and Tracking",
    metaDescription: "Pelvic pain means different things at different points in your cycle. Here's how to tell the difference and what's worth tracking.",
  },
  {
    slug: "nausea-before-period",
    name: "Nausea Before Period",
    phase: "Luteal",
    description: "Nausea in the days before your period is a common but often overlooked PMS symptom. It is linked to hormonal changes in the luteal phase, particularly prostaglandin production.",
    causes: "Rising prostaglandins before your period can cause nausea, particularly when they affect the digestive system. Hormonal fluctuations in estrogen and progesterone in the luteal phase also contribute. Nausea can worsen with low blood sugar.",
    tracking: "Log nausea intensity and timing relative to your period start date. Note whether it correlates with food, time of day, or other symptoms like cramps or bloating. Consistent patterns across cycles confirm it is cycle-related.",
    whenToSeeDoctor: "See a doctor if nausea is severe, persists through your period, is accompanied by vomiting, or is a new symptom that has appeared without explanation.",
    related: ["bloating-before-period", "cramps-during-period", "food-cravings-luteal-phase"],
    metaTitle: "Nausea Before Your Period: Why It Happens and What Helps",
    metaDescription: "Pre-period nausea is a real PMS symptom linked to prostaglandins and hormone shifts. Here's what causes it and how tracking helps.",
  },
  {
    slug: "vaginal-dryness-perimenopause",
    name: "Vaginal Dryness",
    phase: "Perimenopause",
    description: "Vaginal dryness is one of the most common symptoms of perimenopause and menopause. It is caused by declining estrogen levels and can significantly affect comfort and quality of life.",
    causes: "Declining estrogen causes the vaginal tissues to become thinner, drier, and less elastic — a condition called genitourinary syndrome of menopause (GSM). It can also occur with hormonal birth control, breastfeeding, or at certain cycle phases.",
    tracking: "Note severity, whether it varies with cycle phase, and any accompanying symptoms like itching, discomfort, or painful sex. Tracking over time helps identify whether it is worsening and correlates with other perimenopause symptoms.",
    whenToSeeDoctor: "Worth discussing with a doctor — effective treatments exist including topical estrogen, lubricants, and moisturisers. Do not suffer in silence with this symptom.",
    related: ["painful-sex", "irregular-periods-perimenopause", "anxiety-perimenopause"],
    metaTitle: "Vaginal Dryness in Perimenopause: Causes and What Helps",
    metaDescription: "Vaginal dryness is a very common perimenopause symptom caused by declining estrogen. Here's what to know and when to seek treatment.",
  },
  {
    slug: "weight-gain-perimenopause",
    name: "Weight Gain in Perimenopause",
    phase: "Perimenopause",
    description: "Weight gain — particularly around the abdomen — is a common complaint during perimenopause. Hormonal changes affect metabolism, fat distribution, and insulin sensitivity.",
    causes: "Declining estrogen shifts fat storage from the hips and thighs to the abdomen. Progesterone decline can cause water retention. Reduced muscle mass with age lowers metabolic rate. Cortisol reactivity and sleep disruption also contribute.",
    tracking: "Track energy, sleep quality, stress, and exercise alongside weight or measurements. Hormonal patterns often explain fluctuations — water retention before your period, for example, is different from actual fat gain.",
    whenToSeeDoctor: "See a doctor if weight gain is rapid, unexplained, or accompanied by other symptoms like fatigue, cold intolerance, or hair loss — thyroid dysfunction can mimic perimenopause and cause weight gain.",
    related: ["irregular-periods-perimenopause", "night-sweats-perimenopause", "fatigue-perimenopause"],
    metaTitle: "Weight Gain in Perimenopause: Why It Happens and What to Track",
    metaDescription: "Abdominal weight gain in perimenopause is hormonal, not just lifestyle. Here's what's driving it and how tracking helps you understand the pattern.",
  },
  {
    slug: "hair-loss-hormonal",
    name: "Hormonal Hair Loss",
    phase: "All",
    description: "Hair thinning or loss related to hormones is more common than most people realise. It can occur at different life stages and is linked to androgens, thyroid hormones, estrogen, and iron levels.",
    causes: "In PCOS, elevated androgens miniaturise hair follicles causing female pattern hair loss. In perimenopause, declining estrogen and relative androgen dominance can trigger shedding. Thyroid dysfunction and iron deficiency are other common hormonal causes.",
    tracking: "Note when shedding seems heavier, whether it correlates with cycle phase or life stress, and any other hormonal symptoms. Hair loss is often the symptom that prompts women to investigate their hormonal health more broadly.",
    whenToSeeDoctor: "See a doctor for blood tests including thyroid function, ferritin, androgens, and hormones. Hair loss is almost always a symptom of something treatable.",
    related: ["irregular-periods-pcos", "acne-hormonal", "fatigue-perimenopause"],
    metaTitle: "Hormonal Hair Loss: Causes, Cycle Connection and What to Track",
    metaDescription: "Hair thinning linked to hormones is common in PCOS and perimenopause. Here's what causes it and why tracking your cycle helps.",
  },
  {
    slug: "lower-back-pain-period",
    name: "Lower Back Pain Before and During Period",
    phase: "Menstrual",
    description: "Lower back pain is a common period symptom caused by uterine contractions radiating to the lower back. For some people it is more prominent than abdominal cramping.",
    causes: "Prostaglandins cause the uterus to contract during menstruation. These contractions can radiate to the lower back and upper thighs. More severe back pain can be associated with endometriosis, fibroids, or adenomyosis.",
    tracking: "Log pain intensity, location, and timing relative to your period start. Note whether it begins before your period or only once flow starts. Consistent severe back pain warrants investigation.",
    whenToSeeDoctor: "See a doctor if back pain is severe, debilitating, begins well before your period, or is getting worse cycle to cycle — these patterns can indicate endometriosis or adenomyosis.",
    related: ["cramps-during-period", "pelvic-pain", "heavy-period"],
    metaTitle: "Lower Back Pain Before and During Your Period: Causes and Relief",
    metaDescription: "Lower back pain during your period is caused by uterine contractions — but severe or worsening pain can signal something more. Here's what to track.",
  },
  {
    slug: "clots-during-period",
    name: "Blood Clots During Period",
    phase: "Menstrual",
    description: "Passing small blood clots during your period is common and usually normal. Larger or more frequent clots can indicate heavy menstrual bleeding or an underlying condition.",
    causes: "Clots form when blood pools in the uterus faster than anticoagulants can break it down — common during heavy flow days. Larger or more frequent clots can be associated with fibroids, adenomyosis, or hormonal imbalance.",
    tracking: "Note clot size (smaller or larger than a 50p/quarter coin), frequency, and which days of your period they occur. Log flow heaviness alongside. Changes over time — more clots, larger clots — are worth noting.",
    whenToSeeDoctor: "See a doctor if clots are larger than a 50p coin, if you are soaking through a pad or tampon every hour, if this is a change from your normal, or if you feel faint or unusually fatigued during your period.",
    related: ["heavy-period", "cramps-during-period", "lower-back-pain-period"],
    metaTitle: "Blood Clots During Your Period: What's Normal and What's Not",
    metaDescription: "Small clots during your period are usually normal. Larger ones may signal heavy bleeding or fibroids. Here's how to tell the difference.",
  },
  {
    slug: "discharge-before-period",
    name: "Discharge Before Period",
    phase: "Luteal",
    description: "Vaginal discharge changes throughout your cycle under hormonal influence. The discharge you experience in the days before your period is typically white or cloudy and thicker than mid-cycle discharge.",
    causes: "In the luteal phase, progesterone dominates and causes discharge to become thicker, whiter, and less stretchy than ovulation discharge. This is normal. Changes in colour, smell, or texture outside this pattern may indicate infection.",
    tracking: "Note discharge colour, texture, and amount each day. Over time you will see a clear cycle pattern — watery/stretchy around ovulation, thicker/white before your period, minimal just after. Deviations from your pattern are informative.",
    whenToSeeDoctor: "See a doctor if discharge has an unusual smell, is yellow or green, is accompanied by itching or burning, or appears outside your normal pattern — these can indicate bacterial vaginosis, thrush, or STI.",
    related: ["ovulation-discharge", "spotting-between-periods", "irregular-periods"],
    metaTitle: "Discharge Before Your Period: What's Normal Through Your Cycle",
    metaDescription: "Discharge changes throughout your cycle — thicker and white before your period is normal. Here's what the pattern looks like and when to get checked.",
  },
  {
    slug: "dizziness-during-period",
    name: "Dizziness During Period",
    phase: "Menstrual",
    description: "Feeling dizzy or lightheaded during your period is more common than often discussed. It can be caused by blood loss, prostaglandins, low blood pressure, or low blood sugar.",
    causes: "Heavy menstrual bleeding can cause temporary anaemia or low blood pressure, leading to dizziness. Prostaglandins can cause nausea and light-headedness. Vasovagal responses to cramping pain can also cause dizziness or fainting.",
    tracking: "Log when dizziness occurs relative to flow days and cramping. Note whether it is worse when standing up quickly (postural hypotension) or more constant. Also track how heavy your flow is on those days.",
    whenToSeeDoctor: "See a doctor if dizziness is severe, if you faint or nearly faint, if it is accompanied by very heavy bleeding, or if it is a new or worsening symptom.",
    related: ["heavy-period", "cramps-during-period", "fatigue-luteal-phase"],
    metaTitle: "Dizziness During Your Period: Causes and What to Track",
    metaDescription: "Dizziness during your period can be caused by blood loss, prostaglandins, or low blood pressure. Here's what's normal and when to get checked.",
  },
  {
    slug: "fatigue-perimenopause",
    name: "Fatigue in Perimenopause",
    phase: "Perimenopause",
    description: "Persistent fatigue is one of the most commonly reported perimenopause symptoms. It is often linked to sleep disruption, hormonal changes, and the cumulative effect of other symptoms.",
    causes: "Night sweats and sleep disruption are primary drivers — poor sleep compounds quickly. Declining progesterone (which has a calming, sleep-promoting effect) directly affects sleep quality. Thyroid changes common in perimenopause also cause fatigue. Anaemia should be ruled out.",
    tracking: "Log sleep quality, night waking, energy level, and mood daily. Fatigue rarely exists in isolation — tracking alongside sleep and other symptoms reveals whether it is sleep-driven, hormonal, or both.",
    whenToSeeDoctor: "See a doctor if fatigue is severe and persistent, or if accompanied by cold intolerance, weight gain, or hair loss — thyroid dysfunction is common in perimenopause and causes fatigue.",
    related: ["night-sweats-perimenopause", "sleep-problems-before-period", "anxiety-perimenopause"],
    metaTitle: "Fatigue in Perimenopause: Why You're Exhausted and What Helps",
    metaDescription: "Perimenopause fatigue is real and hormonal — driven by sleep disruption, progesterone decline, and thyroid changes. Here's what to track.",
  },
  {
    slug: "bloating-perimenopause",
    name: "Bloating in Perimenopause",
    phase: "Perimenopause",
    description: "Bloating and abdominal distension are common in perimenopause, driven by estrogen fluctuations that affect fluid retention and gut motility.",
    causes: "Fluctuating estrogen affects how the gut moves and how much fluid is retained. Progesterone decline slows digestion. Cortisol changes affect gut bacteria. Many perimenopausal women notice bloating that is worse at certain cycle phases.",
    tracking: "Log bloating intensity and timing relative to your cycle. Note whether it correlates with specific foods, stress, or sleep. Perimenopause bloating often has a clear cycle pattern once you track it for 2-3 months.",
    whenToSeeDoctor: "See a doctor if bloating is severe, persistent regardless of cycle phase, accompanied by changes in bowel habits, or if you have a family history of ovarian cancer — persistent bloating is one of its symptoms.",
    related: ["bloating-before-period", "weight-gain-perimenopause", "irregular-periods-perimenopause"],
    metaTitle: "Bloating in Perimenopause: Hormonal Causes and How to Track It",
    metaDescription: "Perimenopause bloating is driven by estrogen fluctuations and progesterone decline. Here's why it happens and how tracking reveals your pattern.",
  },
];
